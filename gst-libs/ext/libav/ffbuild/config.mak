...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr --enable-static --enable-pic --disable-avdevice --disable-postproc --disable-programs --disable-ffserver --disable-ffplay --disable-ffprobe --disable-ffmpeg --disable-encoder=flac --disable-protocols --disable-devices --disable-network --disable-hwaccels --disable-dxva2 --disable-vdpau --disable-filters --enable-filter=yadif --disable-doc --disable-vda --disable-d3d11va --disable-dxva2 --disable-audiotoolbox --disable-videotoolbox --disable-vaapi --disable-crystalhd --disable-mediacodec --disable-nvenc --disable-mmal --disable-omx --disable-omx-rpi --disable-cuda --disable-cuvid --disable-libmfx --disable-libnpp --disable-iconv --disable-jni --enable-optimizations --enable-cross-compile --target-os=linux --arch=arm --cross-prefix=arm-linux-gnueabihf- --ar=arm-linux-gnueabihf-ar --as=arm-linux-gnueabihf-gcc --cc=arm-linux-gnueabihf-gcc --ld=arm-linux-gnueabihf-gcc --nm='/usr/bin/arm-linux-gnueabihf-nm -B' --disable-ffmpeg
prefix=/usr
...
CC_IDENT=gcc 6.3.0 (Debian 6.3.0-18) 20170516
ARCH=arm
INTRINSICS=none
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
CFLAGS=-g -O2 -fdebug-prefix-map=/home/rk/workspace/gst-libav-git=. -fstack-protector-strong -Wformat -Werror=format-security   -march=armv7-a -std=c11 -fomit-frame-pointer -fPIC -mthumb -pthread  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=-g -O2 -fdebug-prefix-map=/home/rk/workspace/gst-libav-git=. -fstack-protector-strong -Wformat -Werror=format-security  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=-g -O2 -fdebug-prefix-map=/home/rk/workspace/gst-libav-git=. -fstack-protector-strong -Wformat -Werror=format-security  
...
DOXYGEN=doxygen
LDFLAGS=-Wl,-z,relro  -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-L/usr/lib/arm-linux-gnueabihf -lxcb -L/usr/lib/arm-linux-gnueabihf -lxcb-shm -L/usr/lib/arm-linux-gnueabihf -lxcb-xfixes -L/usr/lib/arm-linux-gnueabihf -lxcb-shape -lm -lz -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
